...
export default function Mempelai({ variant = 'khurin' }) {
  // Simpan card masing-masing ke variabel biar gampang di-switch
  const wanitaCard = (
    <PersonCard 
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 40, position: 'relative', zIndex: 1 }}>
        ...
        {/* LOGIKA SWAP: Jika cowo, taruh priaCard duluan. */}
        {variant === 'idzim' ? priaCard : wanitaCard}
        
        {pembatasHati}
        
        {/* Lanjutan Logika Swap */}
        {variant === 'idzim' ? wanitaCard : priaCard}
